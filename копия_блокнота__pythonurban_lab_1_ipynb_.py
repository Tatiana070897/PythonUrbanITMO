...
Original file is located at
    https://colab.research.google.com/drive/108o-W8tOmariHoZrGtBngRpPcvOnE6_7
...
def task_1(list):  # FIXME заменить list на list_
...
def task_2(list): # FIXME заменить list на list_
 return [city for city in list if city["population"] > filter_population]
new_list_dict_cities = task_2(list_dict_cities) # TODO вызвать функцию и передать в неё значения list_dict_cities и filter_population
...
#сверилась с последней лекцией и подправила свое решение опираясь на пример в ней, но результат вышел другим
